...
<?php
if ((int)get_theme_option('Homepage Recent Items')) {
    $homepageRecentItems = get_theme_option('Homepage Recent Items');
} else {
    $homepageRecentItems = '3';
}
set_loop_records('items', get_recent_items($homepageRecentItems));

if (has_loop_records('items')) :
?>
    <ul class="items-list"><?php
